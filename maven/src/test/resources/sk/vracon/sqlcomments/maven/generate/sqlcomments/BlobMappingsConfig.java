...
/**
 * SQLComments configuration class for statement blobMappings.
 */
public class BlobMappingsConfig implements StatementConfiguration {
    ...
    /**
     * Creates new instance of SQLComments configuration class for statement blobMappings.
     */
    ...
    public String toString() {
        ...
        builder.append("BlobMappingsConfig [statementName=");
