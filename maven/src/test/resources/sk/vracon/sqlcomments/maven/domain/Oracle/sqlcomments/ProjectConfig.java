...
public class ProjectConfig implements StatementConfiguration {
    ...
    private static final Map<String, Type<?>> __parameterTypes = Map.ofEntries(
                ...
                Map.entry("projid", NumericType.getInstance()),
     ...
     */
    public ProjectConfig(CRUDType operation, sk.vracon.sqlcomments.maven.domain.Oracle.Project domain) {
        this(operation);
     ...
     * Placeholder is mapped to proj.EMPNO.
     */
    public ProjectConfig withEmpno(BigDecimal value) {
        setEmpno(value);
     ...
     * Placeholder is mapped to proj.PROJID.
     */
    public ProjectConfig withProjid(BigDecimal value) {
        setProjid(value);
    ...
    public Class<?> baseClass() {
        return sk.vracon.sqlcomments.maven.domain.Oracle.Project.class;
    }
