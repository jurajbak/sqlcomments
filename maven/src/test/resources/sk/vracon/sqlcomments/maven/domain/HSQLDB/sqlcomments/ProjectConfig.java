...
public class ProjectConfig implements StatementConfiguration {
     ...
     */
    public ProjectConfig(CRUDType operation, sk.vracon.sqlcomments.maven.domain.HSQLDB.Project domain) {
        this(operation);
    ...
    public Class<?> baseClass() {
        return sk.vracon.sqlcomments.maven.domain.HSQLDB.Project.class;
    }
