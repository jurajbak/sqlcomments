...
/**
 * SQLComments configuration class for statement simpleSelect.
 */
public class SimpleSelectConfig implements StatementConfiguration {
    ...
    /**
     * Creates new instance of SQLComments configuration class for statement simpleSelect.
     */
    ...
    public Class<?> baseClass() {
        return sk.vracon.sqlcomments.maven.generate.SimpleSelect.class;
    }
    ...
    public String toString() {
        ...
        builder.append("SimpleSelectConfig [statementName=");
