...
/**
 * SQLComments configuration class for statement simpleAsterix.
 */
public class SimpleAsterixConfig implements StatementConfiguration {
    ...
    /**
     * Creates new instance of SQLComments configuration class for statement simpleAsterix.
     */
    ...
    public String toString() {
        ...
        builder.append("SimpleAsterixConfig [statementName=");
