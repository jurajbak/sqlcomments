...
/**
 * SQLComments result mapper class for statement blobMappings.
 * <p>
...
public class BlobMappingsMapper implements ResultMapper<BlobMappings> {
    ...
    /**
     * Static instance of BlobMappingsMapper class.
     */
    ...
    /**
     * Reads one database statement result row and transforms it to instance of {@link BlobMappings}.
     *
     * @param resultSet select statement {@link ResultSet} pointing to row to be red
     * @return new instance of {@link BlobMappings} filled by data from database result
     */
