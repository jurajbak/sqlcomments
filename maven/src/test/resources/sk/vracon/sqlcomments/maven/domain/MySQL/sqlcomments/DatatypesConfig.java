...
public class DatatypesConfig implements StatementConfiguration {
     ...
     */
    public DatatypesConfig(CRUDType operation, sk.vracon.sqlcomments.maven.domain.MySQL.Datatypes domain) {
        this(operation);
    ...
    public Class<?> baseClass() {
        return sk.vracon.sqlcomments.maven.domain.MySQL.Datatypes.class;
    }
