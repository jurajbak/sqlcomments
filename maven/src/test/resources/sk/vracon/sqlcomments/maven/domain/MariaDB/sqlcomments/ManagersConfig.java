...
public class ManagersConfig implements StatementConfiguration {
     ...
     */
    public ManagersConfig(CRUDType operation, sk.vracon.sqlcomments.maven.domain.MariaDB.Managers domain) {
        this(operation);
    ...
    public Class<?> baseClass() {
        return sk.vracon.sqlcomments.maven.domain.MariaDB.Managers.class;
    }
