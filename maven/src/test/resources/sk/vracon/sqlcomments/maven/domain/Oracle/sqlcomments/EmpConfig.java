...
public class EmpConfig implements StatementConfiguration {
    ...
    private static final Map<String, Type<?>> __parameterTypes = Map.ofEntries(
                Map.entry("comm", NumericType.getInstance()),
                Map.entry("deptno", NumericType.getInstance()),
                ...
                Map.entry("mgr", NumericType.getInstance()),
                Map.entry("sal", NumericType.getInstance()));
     ...
     */
    public EmpConfig(CRUDType operation, sk.vracon.sqlcomments.maven.domain.Oracle.Emp domain) {
        this(operation);
     ...
     * Placeholder is mapped to emp.COMM.
     */
    public EmpConfig withComm(BigDecimal value) {
        setComm(value);
     ...
     */
    public void setDeptno(BigDecimal value) {
     ...
     * Placeholder is mapped to emp.DEPTNO.
     */
    public EmpConfig withDeptno(BigDecimal value) {
        setDeptno(value);
     ...
     * Placeholder is mapped to emp.EMPNO.
     */
    public EmpConfig withEmpno(BigDecimal value) {
        setEmpno(value);
     ...
     */
    public void setMgr(BigDecimal value) {
     ...
     * Placeholder is mapped to emp.MGR.
     */
    public EmpConfig withMgr(BigDecimal value) {
        setMgr(value);
     ...
     * Placeholder is mapped to emp.SAL.
     */
    public EmpConfig withSal(BigDecimal value) {
        setSal(value);
