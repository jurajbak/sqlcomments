...
public class EmpConfig implements StatementConfiguration {
     ...
     */
    public EmpConfig(CRUDType operation, sk.vracon.sqlcomments.maven.domain.PostgreSQL.Emp domain) {
        this(operation);
    ...
    public Class<?> baseClass() {
        return sk.vracon.sqlcomments.maven.domain.PostgreSQL.Emp.class;
    }
