-- EmployeesQX - SQLite.sql
-- Use DBeaver or another SQLite administrator.
...
CREATE TABLE "datatypes" (
   ...
   "INTEGER_" INTEGER NOT NULL DEFAULT 44,
   "TINY_INT" TINYINT,
   "MEDIUM_INT" MEDIUMINT,
   "BIG_INT" BIGINT,
   "U_BIG_INT" UNSIGNED BIG INT,
   "BOOLEAN_" BOOLEAN,
   
   "FLOAT_" FLOAT DEFAULT 44.55,
   "REAL_" REAL DEFAULT 55.67,
   "DOUBLE_PRECISION" DOUBLE PRECISION,

   "CHAR_" CHAR(5) DEFAULT 'QWERT',
   "NCHAR_" NCHAR(5) DEFAULT 'QWERT',
   "VARCHAR_" VARCHAR(50) DEFAULT 'abc',
   "NVARCHAR_" NVARCHAR(50) DEFAULT 'abc',
   "TEXT_" TEXT,

   "DATETIME_" DATETIME DEFAULT '2016-01-02',
   "DATE_" DATE,
...
INSERT INTO "datatypes" ("CHAR_", "DATETIME_", "FLOAT_", "INTEGER_", "VARCHAR_", "REAL_") 
   VALUES ('abcde', '2015-10-15', 22.33, 1234, 'abcdefg', 567.788);
