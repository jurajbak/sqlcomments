...
public class LongType extends AbstractType<Long> {
	 ...
	 */
	protected static final int DATA_RANGE_INDEX = 90;
	 ...
	 * @see Type#getTypeOrderIndex()
	 */
	public LongType(int[] sqlTypes, int dataRangeIndex) {
		super(sqlTypes, Long.class, dataRangeIndex);
	}

	@Override
	public Long readValue(ResultSet resultSet, String columnName) throws SQLException {
	...
	@Override
	public void writeValue(PreparedStatement statement, int columnIndex, Long value) throws SQLException {
		if (value == null) {
	 ...
	 */
	public static LongType getInstance(Object... params) {
		if (INSTANCE == null) {
