...
public class StatementGenerator {
    ...
    public PreparedStatement createPreparedStatement(Connection connection, Statement statement, Map<String, Object> parameters,
        ...
        try {
            ...
            int autoGeneratedKeys = withKeys ? java.sql.Statement.RETURN_GENERATED_KEYS : java.sql.Statement.NO_GENERATED_KEYS;
            PreparedStatement jdbcStatement = connection.prepareStatement(jdbcSql, autoGeneratedKeys);
