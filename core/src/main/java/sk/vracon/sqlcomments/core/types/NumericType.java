 ...
 * Numeric data type.
 */
public class NumericType extends AbstractType<BigDecimal> {
	 ...
	 * @see Type#getTypeOrderIndex()
	 */
	public NumericType(int[] sqlTypes, int dataRangeIndex) {
		super(sqlTypes, BigDecimal.class, dataRangeIndex);
	}

	@Override
	public BigDecimal readValue(ResultSet resultSet, String columnName) throws SQLException {
	...
	@Override
	public void writeValue(PreparedStatement statement, int columnIndex, BigDecimal value) throws SQLException {
		if (value == null) {
	 ...
	 */
	public static NumericType getInstance(Object... params) {
		if (INSTANCE == null) {
