...
/**
 * This is special, marker {@link Type}. It is also a most generic type representing Object or undefined type.  
 */
public class ObjectOrUndefinedType extends AbstractType<Object> {
	...
	private static ObjectOrUndefinedType INSTANCE;
	 ...
	 */
	protected static final int DATA_RANGE_INDEX = 0;
	
	/**
	 * Constructor to create instance initialised by default settings. 
	 */
	public ObjectOrUndefinedType() {
	 ...
	 * @see Type#getTypeOrderIndex()
	 */
	public ObjectOrUndefinedType(int[] sqlTypes, int dataRangeIndex) {
		super(sqlTypes, Object.class, dataRangeIndex);
	}
	...
	@Override
	public void writeValue(PreparedStatement statement, int columnIndex, Object value) throws SQLException {
	 ...
	 */
	public static ObjectOrUndefinedType getInstance(Object... params) {
		if (INSTANCE == null) {
			INSTANCE = new ObjectOrUndefinedType();
		}
		return INSTANCE;
	}
}