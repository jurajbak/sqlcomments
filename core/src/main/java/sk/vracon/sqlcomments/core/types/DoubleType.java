...
public class DoubleType extends AbstractType<Double> {
	 ...
	 * @see Type#getTypeOrderIndex()
	 */
	public DoubleType(int[] sqlTypes, int dataRangeIndex) {
		super(sqlTypes, Double.class, dataRangeIndex);
	}

	@Override
	public Double readValue(ResultSet resultSet, String columnName) throws SQLException {
	...
	@Override
	public void writeValue(PreparedStatement statement, int columnIndex, Double value) throws SQLException {
		if (value == null) {
	 ...
	 */
	public static DoubleType getInstance(Object... params) {
		if (INSTANCE == null) {
