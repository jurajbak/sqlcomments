...
public class DurationType extends AbstractType<Duration> {
	...
	private static DurationType INSTANCE;
	 ...
	 * @see Type#getTypeOrderIndex()
	 */
	public DurationType(int[] sqlTypes, int dataRangeIndex) {
		super(sqlTypes, Duration.class, dataRangeIndex);
	}

	@Override
	public Duration readValue(ResultSet resultSet, String columnName) throws SQLException {
		Duration value = resultSet.getObject(columnName, Duration.class);
	...
	@Override
	public void writeValue(PreparedStatement statement, int columnIndex, Duration value) throws SQLException {
		if (value == null) {
	 ...
	 */
	public static DurationType getInstance(Object... params) {
		if (INSTANCE == null) {
